...
function MyApp({ Component, pageProps }) {
  ...
  return (<>
    <Head>
        <title>Eminxyp</title>
        <link rel="shortcut icon" href="https://cdn.discordapp.com/attachments/1120773551255978106/1176938380664250520/sm7qozo.jpeg?ex=6570b048&is=655e3b48&hm=f3ecd07d68899b2d9efc01dc2e495a971538b62290bf79d7a8e3448bda3c54ba&" type="image/x-icon" ></link>
        ...
        <div style={{ zIndex: 99999 }} className="fixed bg-black/75 w-full h-screen flex justify-center items-center pointer-events-none">
            <div className="flex items-center gap-x-6 animate-pulse">
                <div className="text-center">
                    <p className="text-6xl mb-5 font-semibold">Eminxyp</p>
        ...
        <div className="max-w-screen-lg p-5 w-full md:w-10/12 lg:w-8/12 mx-auto transition-all duration-300">
          <div className="md:flex w-full items-center justify-between">
            ...
            <div className="mt-2 md:mt-0 flex items-center">
              <a href="https://discord.gg/JzqXrWFBjZ" target="_blank" rel="noreferrer" className="w-full md:w-auto bg-neutral-700/5 hover:bg-neutral-700/20 px-4 py-2 rounded-md transition-all duration-200">
                <i className="fab fa-discord mr-2" />Discord'a katıl
              </a>
            </div>
